...
from app.config.constants import DEFAULT_SUMMARIZATION_MODEL
...
class CodeSummarizer:
    ...
    def __init__(self, model: str = DEFAULT_SUMMARIZATION_MODEL):
        """
        ...
        logger.info(f"[CTX] Initialized CodeSummarizer with model={model}")
