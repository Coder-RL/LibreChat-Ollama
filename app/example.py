#!/usr/bin/env python3
"""
Example script demonstrating the intelligent context injection system.
"""
...
from context.role_context_injector import RoleAwareContextInjector
...
def main():
    ...
    if len(sys.argv) < 2:
        print("Usage: python example.py <prompt> [role]")
        sys.exit(1)
