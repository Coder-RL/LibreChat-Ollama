...
-- Fix for pgvector dimension offset issue
BEGIN;
...
-- Verify the new tables have the expected configuration
SELECT
...
-- Force table swap (since we know dimension offset is expected)
